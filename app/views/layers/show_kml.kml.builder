...
wms_baseurl = "http://"+request.host_with_port+ url_for(:controller => "layers", :action=> "wms", :id=>@layer.id)
this_baseurl = "http://"+request.host_with_port+ url_for(:controller => "layers", :action=> "show", :id=>@layer.id, :format=>"kml")
xml.instruct! :xml
