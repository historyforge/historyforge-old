class Census1930FormFields < CensusFormFields
  ...
  input :foreign_born, as: :boolean, label: 'This person is foreign born', inline_label: 'Yes'
  input :mother_tongue, input_html: { autocomplete: 'new-password' }
  input :year_immigrated, as: :integer, hint: 'Enter 999 for unknown or leave blank if taker left empty'
  input :naturalized_alien, as: :radio_buttons, collection: CensusRecord.naturalized_alien_choices, coded: true
