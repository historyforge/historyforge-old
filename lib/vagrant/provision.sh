...
apt install -y postgresql-10-postgis-2.4 postgresql-server-dev-all libxml2-dev ruby-dev imagemagick libgdal-dev gdal-bin ruby-mapscript nodejs imagemagick
