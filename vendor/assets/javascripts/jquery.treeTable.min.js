 ...
 */
$.fn.draggableTable = function(options) {
    return this.each(function(){
        if (!$(this).hasClass('tabledrag-processed'))
            return new DDTable(this, null, options);
        else
 ...
 */
var DDTable = function(table, tableSettings, options) {
  var self = this;
  ...
  this.indentEnabled = options && options.indentEnabled || true;
  this.maxDepth = options && options.maxDepth || 3;
